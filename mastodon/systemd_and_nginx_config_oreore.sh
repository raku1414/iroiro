...
mastodon_crt="/etc/letsencrypt/live/$mastodon_domain/fullchain.pem"
mastodon_key="/etc/letsencrypt/live/$mastodon_domain/privkey.pem"
...
sudo expect -c "
set timeout 20
spawn openssl req -x509 -nodes -new -days 365 -keyout $mastodon_key -out $mastodon_crt
expect \"Country Name\"
send \"\n\"
